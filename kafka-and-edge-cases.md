...
Данный раздел описывает обработку краевых кейсов для этапа создания доставки у внешнего партнёра.

Процесс начинается после публикации события DELIVERY_CREATION_REQUESTED в Kafka.

Основной consumer события - Delivery Integration Service.
