# System Design Case: Доставка через внешнего партнера для интернет-магазина

## Контекст

Интернет-магазину необходимо добавить возможность доставки, предоставляемую внешним логистическим партнёром.
Цель кейса — спроектировать процесс оформления заказа с доставкой, интеграции между системами, API, события, статусы, обработку ошибок и компенсационные действия.
